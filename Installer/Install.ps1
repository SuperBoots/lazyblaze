...
InstallFile -TargetDir "$($installLocation)Scripts\PowershellModules\" -TargetFileName "BackupConfigFile.psm1" -SourceFile ".\FilesToInstall\PowershellModules\BackupConfigFile.psm1" -FileType ".psm1" -MajorVersion $installMajorVersion -MinorVersion $installMinorVersion
InstallFile -TargetDir "$($installLocation)Scripts\PowershellModules\" -TargetFileName "CleanForEnvVar.psm1" -SourceFile ".\FilesToInstall\PowershellModules\CleanForEnvVar.psm1" -FileType ".psm1" -MajorVersion $installMajorVersion -MinorVersion $installMinorVersion
InstallFile -TargetDir "$($installLocation)Scripts\PowershellModules\" -TargetFileName "CloneGitRepo.psm1" -SourceFile ".\FilesToInstall\PowershellModules\CloneGitRepo.psm1" -FileType ".psm1" -MajorVersion $installMajorVersion -MinorVersion $installMinorVersion
...
InstallFile -TargetDir "$($installLocation)Scripts\PowershellModules\" -TargetFileName "ExcludeFromBackblaze.psm1" -SourceFile ".\FilesToInstall\PowershellModules\ExcludeFromBackblaze.psm1" -FileType ".psm1" -MajorVersion $installMajorVersion -MinorVersion $installMinorVersion
...
InstallFile -TargetDir "$($installLocation)Scripts\PowershellModules\" -TargetFileName "MoveShortcuts.psm1" -SourceFile ".\FilesToInstall\PowershellModules\MoveShortcuts.psm1" -FileType ".psm1" -MajorVersion $installMajorVersion -MinorVersion $installMinorVersion
InstallFile -TargetDir "$($installLocation)Scripts\PowershellModules\" -TargetFileName "PopulateConfigFile.psm1" -SourceFile ".\FilesToInstall\PowershellModules\PopulateConfigFile.psm1" -FileType ".psm1" -MajorVersion $installMajorVersion -MinorVersion $installMinorVersion
InstallFile -TargetDir "$($installLocation)Scripts\PowershellModules\" -TargetFileName "RemoveBrokenShortcuts.psm1" -SourceFile ".\FilesToInstall\PowershellModules\RemoveBrokenShortcuts.psm1" -FileType ".psm1" -MajorVersion $installMajorVersion -MinorVersion $installMinorVersion
